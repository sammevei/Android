local sceneName = CreateTransportController

-- Include
local view = require("view.CreateTransportView")
...
saveTransports = function(event)
    ...
    -- indicate whether it's a first session and set variable to handle firstTransportButton
...
onTripChangeStart = function(event)
    ...
    elseif changing == false and changeWasJustClosed == false then
        ...
        view.destinationField.placeholder = "Adresse:"
        view.departureField.text = ""
        view.departureField.placeholder = "Adresse:"
...
departureFieldListener = function(event)
    if ( event.phase == "began" ) then
        ...
        transition.to( view.tripChangeGroup, { time = 100, y = 130 + display.screenOriginY } )
