...
function newButton( params )
	local button, default, over, defaultX, defaultY, overX, overY, size, font, textColor, offset
	
	if params.default then
		button = display.newGroup()
		default = display.newImageRect ( params.default, params.defaultX, params.defaultY )
		button:insert( default, true )
	end
	
	if params.over then
		over = display.newImageRect ( params.over, params.overX , params.overY )
		over.isVisible = false
